...
class Classification:
    ...
    def train_clf(self):
        ...
        df = pd.DataFrame({'accuracy': [rfc_acc, xgb_acc, knn_acc, ada_acc, gb_acc, gau_acc],
                           'precision': [rfc_score[0], xgb_score[0], knn_score[0], ada_score[0], gb_score[0], gau_score[0]], 
                           'recall': [rfc_score[1], xgb_score[1], knn_score[1], ada_score[1], gb_score[1], gau_score[1]], 
                           'f1_score': [rfc_score[2], xgb_score[2], knn_score[2], ada_score[2], gb_score[2], gau_score[2]]}, 
...
class Regression:
    ...
    def train_reg(self):
        ...
        df = pd.DataFrame({'mean_absolute_error': [xgb_mae, rfc_mae, ada_mae, gb_mae, rg_mae, ls_mae, en_mae],
                           'mean_squared_error': [xgb_mse, rfc_mse, ada_mse, gb_mse, rg_mse, ls_mse, en_mse]},
